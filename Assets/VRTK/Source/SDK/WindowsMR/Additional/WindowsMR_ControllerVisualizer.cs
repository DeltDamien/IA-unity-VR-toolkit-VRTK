...
using Windows.Storage.Streams;
    ...
    public class WindowsMR_ControllerVisualizer : MonoBehaviour
    {
        ...
        {
            Debug.Log("LoadControllerModel for " + source.handedness);
        ...
        {
            Debug.Log("LoadSourceControllerModel for " + source.handedness);
        ...
        {
            Debug.Log("FinishControllerSetup for " + handedness);
